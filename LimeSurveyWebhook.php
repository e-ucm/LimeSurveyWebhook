...
class LimeSurveyWebhook extends PluginBase
	{
        ...
        public function getPluginSettings($getValues = true) {
		    ...
		    $this->settings = array(
                ...
                'events' => array(
                    ...
                    'help' => sprintf(
                        $this->gT('A JSON object describing the events to send to the webhook server. The JSON object has the following form: %s You can use this as template : %s'),
                        CHtml::tag('pre', [], "{\n\t\"render\": { ... },\n\t\"authentification\": { ... },\n\t\"admin\": { ... },\n\t\"surveyStatus\": {\n\t\t\"beforeSurveyPage\": true,\n\t\t\"afterSurveyComplete\": false,\n\t},\n\t\"plugin\": { ... },\n\t...\n}"),
                        CHtml::tag('pre', [], self::getDefaultEvents())
                    ),
        ...
        ***** ***** ***** ***** *****/
        ...
        private static function getDefaultEvents() {
            return json_encode([
                'render' => [
                  'beforeAdminMenuRender' => true,
                  'beforePluginManagerMenuRender' => true,
                  'beforeQuestionRender' => true,
                  'beforeSideMenuRender' => true,
                  'beforeSurveyBarRender' => true,
                  'beforeTwigRenderTemplate' => true,
                  'beforeToolsMenuRender' => true,
                  'beforeWelcomePageRender' => true,
                ],
                'authentification' => [
                  'beforeRegister' => true,
                  'beforeRegisterForm' => true,
                  'createNewUser' => true,
                  'createRandomPassword' => true,
                  'checkPasswordRequirement' => true,
                ],
                'admin' => [
                  'afterQuickMenuLoad' => true,
                  'beforeCloseHtml' => true,
                  'beforeControllerAction' => true,
                  'beforeHasPermission' => true,
                  'beforePermissionSetSave' => true,
                  'beforeProcessFileUpload' => true,
                  'beforeUrlCheck' => true,
                  'ExpressionManagerStart' => true,
                  'getGlobalBasePermissions' => true,
                  'getValidScreenFiles' => true,
                  'listExportOptions' => true,
                  'newDirectRequest' => true,
                  'newExport' => true,
                  'NewUnsecureRequest' => true,
                  'setVariableExpressionEnd' => true,
                ],
                'surveyStatus' => [
                ...
                'plugin' => [
                  'afterPluginLoad' => true,
                  'getPluginTwigPath' => true,
                  'listExportPlugins' => true,
                  'listQuestionPlugins' => true,
                ],
                'dynamicmodel' => [
                  'beforeModelDelete' => true,
                  'beforeModelSave' => true,
                  'afterModelDelete' => true,
                  'afterModelSave' => true,
                ],
                'email' => [
                  'afterReceiveOAuthResponse' => true,
                  'afterSelectEmailPlugin' => true,
                  'beforeEmail' => true,
                  'beforeSurveyEmail' => true,
                  'beforeTokenEmail' => true,
                  'beforeEmailDispatch' => true,
                  'beforePrepareRedirectToAuthPage' => true,
                  'beforeRedirectToAuthPage' => true,
                  'listEmailPlugins' => true,
                  'MailerConstruct' => true,
                ],
                'dynamicsurvey' => [
                  'beforeSurveyDynamicDelete' => true,
                  'beforeSurveyDynamicSave' => true,
                  'afterSurveyDynamicDelete' => true,
                  'afterSurveyDynamicSave' => true,
                ],
                'response' => [
                  'beforeResponseDelete' => true,
                  'beforeResponseSave' => true,
                  'afterResponseDelete' => true,
                  'afterResponseSave' => true,
                ],
                'token' => [
                  'afterGenerateToken' => true,
                  'beforeTokenDelete' => true,
                  'beforeTokenSave' => true,
                  'afterTokenDelete' => true,
                  'afterTokenSave' => true,
                  'beforeTokenDynamicDelete' => true,
                  'beforeTokenDynamicSave' => true,
                  'afterTokenDynamicDelete' => true,
                  'afterTokenDynamicSave' => true,
                ],
                'surveyAdmin' => [
                  'afterFindSurvey' => true,
                  'afterSurveyActivate' => true,
                  'afterSurveyDeactivate' => true,
                  'afterSurveyQuestionAssessment' => true,
                  'afterSurveyQuota' => true,
                  'afterSurveySettingsSave' => true,
                  'beforeActivate' => true,
                  'beforeDeactivate' => true,
                  'beforeLoadResponse' => true,
                  'beforeSurveyAdminView' => true,
                  'beforeSurveyActivate' => true,
                  'beforeSurveyDeactivate' => true,
                  'beforeSurveySettings' => true,
                  'newQuestionAttributes' => true,
                  'newSurveySettings' => true,
                  'saveSurveyForm' => true,
                  'beforeSurveyDelete' => true,
                  'beforeSurveySave' => true,
                  'afterSurveyDelete' => true,
                  'afterSurveySave' => true,
                ],
            ]);
        }
